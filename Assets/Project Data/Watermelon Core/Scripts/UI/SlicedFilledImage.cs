...
namespace Watermelon
{
	...
	{
		SerializedProperty spriteProp, colorProp;
		GUIContent spriteLabel;
	...
	public class SlicedFilledImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
	{
		...
		static readonly Vector2[] s_UVs = new Vector2[4];
		static readonly Vector2[] s_SlicedVertices = new Vector2[4];
		static readonly Vector2[] s_SlicedUVs = new Vector2[4];
...
#pragma warning disable 0649
		...
		[SerializeField] FillDirection m_FillDirection;
		...
		[SerializeField] bool m_PreserveBorder = false;
...
#pragma warning restore 0649
		...
		Sprite activeSprite { get { return m_OverrideSprite != null ? m_OverrideSprite : m_Sprite; } }
...
#pragma warning restore 1692
		...
		void GenerateSlicedFilledSprite(VertexHelper vh)
		{
			vh.Clear();
		...
		void GenerateFilledSprite(VertexHelper vh, Vector4 vertices, Vector4 uvs, float fillAmount)
		{
			if (m_FillAmount < 0.001f)
				return;
