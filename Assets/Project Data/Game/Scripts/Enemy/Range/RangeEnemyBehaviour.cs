...
namespace Watermelon.SquadShooter
{
    public class RangeEnemyBehaviour : BaseEnemyBehavior
    {
        ...
        public override void OnAnimatorCallback(EnemyCallbackType enemyCallbackType)
        {
            ...
            {
                var bullet = bulletPool.Get(new PooledObjectSettings(false).SetPosition(shootPointTransform.position).SetRotation(shootPointTransform.eulerAngles)).GetComponent<EnemyBulletBehavior>();
