    ...
    public class MagicBeamScript : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                beamEnd =
                    Instantiate(beamEndPrefab[currentBeam], new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
                beam =
                    Instantiate(beamLineRendererPrefab[currentBeam], new Vector3(0, 0, 0),
