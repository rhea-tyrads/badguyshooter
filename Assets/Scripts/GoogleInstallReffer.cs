...
public class GoogleInstallReffer : MonoBehaviour
{
    void Start()
    {
        ...
        using var referrerClient =
            new AndroidJavaObject("com.android.installreferrer.api.InstallReferrerClient$Builder", context);
...
public class ReferrerStateListener : AndroidJavaProxy
{
    ...
    public ReferrerStateListener(AndroidJavaObject client) : base(
